...
FEintra_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/531_FE_intrames2.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train <- c(201910,201911,201912,202001,202002,202003,202004,202005,202007,202008,202009,202010,202011,202012,202101,202102,202103,202104,202105,202106,202107)
  param_local$train$training <- c(201901,201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,202001,202002,202003,202004,202005,202007,202008,202009,202010)
  param_local$train$validation <- c(202012)
  param_local$train$testing <- c(202101,202102,202103,202104,202105,202106,202107)
...
HT_tuning_base <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    min_gain_to_split = c(0,50), # min_gain_to_split >= 0.0
    min_sum_hessian_in_leaf = 0.001, #  min_sum_hessian_in_leaf >= 0.0
    lambda_l1 = c(0,600), # lambda_l1 >= 0.0
